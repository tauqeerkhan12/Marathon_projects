...
export class Crimes extends React.Component {
    ...
    render() {
        return (
            <div>
                <div className="row">
                    <Link className="btn btn-primary" role="button" style={{ fontSize: '17px', marginBottom: '10px', marginLeft: '3px', marginTop: '20px' }} to={{ pathname: './crimeReportForm' }}>Report Crime</Link>
